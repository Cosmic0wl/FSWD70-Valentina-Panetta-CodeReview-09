...
--
-- Host: localhost
-- Generation Time: Jul 06, 2019 at 04:40 PM
...
--
-- Database: `cr09_valentina_panetta_carrental`
--
CREATE DATABASE IF NOT EXISTS `cr09_valentina_panetta_carrental` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cr09_valentina_panetta_carrental`;
...
--
-- Table structure for table `closest_workshops`
--

DROP TABLE IF EXISTS `closest_workshops`;
CREATE TABLE `closest_workshops` (
...
--
-- Dumping data for table `closest_workshops`
--

INSERT INTO `closest_workshops` (`cw_id`, `fk_workshop_id`, `fk_branch_id`) VALUES
(1, 2, 1),
(2, 3, 2),
(3, 4, 3);
...
INSERT INTO `invoices` (`invoice_id`, `grand_total`, `date_of_issue`, `fk_reservation_id`, `fk_card_id`, `fk_employee_id`) VALUES
(1, 300, '2019-06-15', 1, 1, 14),
(2, 100, '2019-08-20', 1, 1, 3),
(3, 100, '2019-12-13', 2, 2, 9),
(4, 300, '2019-07-15', 3, 3, 15),
(5, 1000, '2019-11-10', 4, 4, 3);
...
(1, '2019-05-09', 90000, 'Tire change, oil change, brake service', 300, 1, 2),
(2, '2019-04-09', 120000, 'Tire change, oil change, brake service', 500, 2, 3),
(3, '2019-04-11', 150000, 'Tire change, oil change, brake service', 500, 3, 4),
(4, '2019-03-09', 200000, 'Oil change, brake service', 350, 4, 2),
(5, '2019-09-09', 250000, 'Tire change, oil change, brake service', 450, 5, 3),
(6, '2019-09-12', 150000, 'Tire change, oil change, brake service', 250, 6, 4),
(7, '2019-03-09', 290000, 'Tire change, brake service', 300, 7, 2),
(8, '2019-09-12', 90000, 'Tire change, oil change, brake service', 500, 9, 4);
...
CREATE TABLE `reservations` (
  ...
  `fk_customer_id` int(11) DEFAULT NULL,
  `fk_vehicle_id` int(11) DEFAULT NULL,
  `fk_pick_up_branch` int(11) DEFAULT NULL,
  `fk_drop_off_branch` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `reservations` (`reservation_id`, `deposit`, `rental_fee`, `rental_date`, `return_date`, `fk_customer_id`, `fk_vehicle_id`, `fk_pick_up_branch`, `fk_drop_off_branch`) VALUES
(1, 200, 100, '2019-06-12', '2019-06-15', 1, 6, 3, 1),
(2, 200, 100, '2019-08-19', '2019-08-20', 1, 7, 1, 1),
(3, 200, 100, '2019-12-12', '2019-12-13', 2, 8, 2, 3),
(4, 200, 100, '2019-07-12', '2019-07-15', 3, 9, 3, 2),
(5, 200, 100, '2019-11-01', '2019-11-10', 4, 5, 1, 2);
...
(7, 'Car', 'Opel Zafira', 5, 'Bio-Diesel', 300000, 'Manual', 1),
...
(2, 'KMH car workshop', 'Dassanowskyweg 12, 1220 Vienna', 434836471),
(3, 'PALA & CO MOTORS', 'Leberstraße 118, 1110 Vienna', 431252071),
(4, 'Euromaster', 'Donaufelder Str. 133, 1210 Vienna', 434836478);
...
--
-- Indexes for table `closest_workshops`
--
ALTER TABLE `closest_workshops`
...
ALTER TABLE `reservations`
  ...
  ADD KEY `fk_customer_id` (`fk_customer_id`),
  ADD KEY `fk_vehicle_id` (`fk_vehicle_id`),
  ADD KEY `fk_pick_up_branch` (`fk_pick_up_branch`),
  ADD KEY `fk_drop_off_branch` (`fk_drop_off_branch`);
...
--
-- AUTO_INCREMENT for table `closest_workshops`
--
ALTER TABLE `closest_workshops`
  MODIFY `cw_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `closest_workshops`
--
ALTER TABLE `closest_workshops`
  ADD CONSTRAINT `closest_workshops_ibfk_1` FOREIGN KEY (`fk_workshop_id`) REFERENCES `workshops` (`workshop_id`),
  ADD CONSTRAINT `closest_workshops_ibfk_2` FOREIGN KEY (`fk_branch_id`) REFERENCES `agency_branches` (`branch_id`);
...
ALTER TABLE `invoices`
  ...
  ADD CONSTRAINT `invoices_ibfk_2` FOREIGN KEY (`fk_card_id`) REFERENCES `credit_cards` (`card_id`),
  ADD CONSTRAINT `invoices_ibfk_3` FOREIGN KEY (`fk_employee_id`) REFERENCES `employees` (`employee_id`);
...
ALTER TABLE `reservations`
  ...
  ADD CONSTRAINT `reservations_ibfk_3` FOREIGN KEY (`fk_pick_up_branch`) REFERENCES `agency_branches` (`branch_id`),
  ADD CONSTRAINT `reservations_ibfk_4` FOREIGN KEY (`fk_drop_off_branch`) REFERENCES `agency_branches` (`branch_id`);
